  ...
  return (
    <div className="w-full select-none touch-manipulation" {...getRootProps()}>
      <motion.div
        ...
        whileHover="animate"
        className={cn(
          "group/file relative block w-full cursor-pointer overflow-hidden rounded-2xl border-2 border-dashed p-6 sm:p-9 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/30 focus-visible:border-emerald-500/50",
          isDragActive
          ...
          <AnimatePresence mode="wait" initial={false}>
            {!files.length ? (
              ...
              <motion.div
                ...
                exit={{ opacity: 0, y: -4 }}
                transition={{ duration: 0.18, ease: [0.23, 1, 0.32, 1] }}
                className="flex items-center justify-between w-full max-w-lg mb-2 text-left"
              >
